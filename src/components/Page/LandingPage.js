...
const LandingPage = () => {
  ...
  return (
    <div>
      {/* Section 1: Hero */}
      <section className="bg-hero text-center flex flex-col py-16 px-12  md:pt-20 relative">
        <p className="text-3xl md:text-6xl lg:text-7xl lg:px-20 font-GothamBlack font-extrabold font-p text-white mb-4">
        ...
        <div className="flex items-center flex-col justify-center md:pt-10 lg:pb-20">
          ...
          <button className="bg-teal-500 w-2/5  text-white font-bold py-2 px-4 rounded-full mt-4 md:text-xl hover:bg-gray-300 hover:text-white transition duration-300">
            Join Us
          </button>

          <button className="bg-yellow-500 w-2/5  text-white font-bold py-2 px-4 rounded-full mt-4 md:text-xl hover:bg-gray-300 hover:text-white transition duration-300">
            Join Us
          </button>
        </div>
        </section> 
        ...
        <div className="bg-blend-image absolute left-0 w-full h-full z-10 lg:mtminf">
          <img src={process.env.PUBLIC_URL + "/charal.png"} alt="Hero" className="w-full mx-auto mb-4 " />
        </div>
      ...
      <section className="bg-white pb-16 px-8 pt-20 md:pt-80 lg:pt-96 text-center">
        <div className="lg:pt-32">
          <img src={process.env.PUBLIC_URL + "/logoent.png"} alt="Logo UKM XYZ" className="w-52 mx-auto mb-4 md:w-72 lg:w-96" />
        <p className="mb-4 text-center text-xs md:text-lg md:px-20 md:pt-5 lg:text-2xl lg:px-28  font-montserrat text-black">ENT is a Journalism and Networking Team hosted by the Computer Network and Information Systems Unit of Politeknik Elektronika Negeri Surabaya (PENS).</p>
        </div>
      ...
      <section className="bg-white  px-8 text-center">
          <img src={process.env.PUBLIC_URL + "iconalldiv.png"} alt="Logo Divisi UKM XYZ" className="mx-auto mb-4 w-full md:p-10 lg:p-20" />
      </section>
       ...
       <section className="px-4 text-center">
            <div className="flex flex-col items-center">
              <div className="flex pt-8 pb-8">
                {['/Cha/CFG.svg', '/Cha/CDG.svg'].includes(IconData[selectedIcon]?.icon2) ? (
                    <>
                        <div className="w-2/5">
                            <img
